...
gen UPDRS = 24 + u0 + (2.25 + u1)*disease_duration + (1/0.34777501)*confounder + (0.125/0.34777501)*confounder*disease_duration + (2.0/0.518)*exp + (0.25/0.518)*exp*disease_duration + lev1_res
...
postfile `memhold' beta_exp beta_int se_int beta_sl se_sl cov_int_sl using simulation_study_snp_ver2_confounders_results_dataset_`bob', replace
