...
gen UPDRS = 24 + u0 + (2.25 + u1)*disease_duration + (1/0.81147503)*confounder + (0.225/0.81147503)*confounder*disease_duration + (2.0/1.159)*exp + lev1_res
...
postfile `memhold' beta_exp beta_int se_int beta_sl se_sl cov_int_sl using simulation_study_snp_ver5_confounders_R2_2perc_results_dataset_`bob', replace
